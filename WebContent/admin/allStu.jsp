                                    ...
                                    <table class="table">
                                        <thead>
                                            ...
                                            <tr onmouseover="this.style.backgroundColor='#F0F8FF';" onmouseout="this.style.backgroundColor='#FFFFFF';">
                                                ...
                                                <th class="per15">学号</th>
                                                <th class="per15">姓名</th>
                                                <th class="per15">性别</th>
                                                <th class="per15">班级</th>
                                                <th class="per15">专业</th>
                                                <th><input id="btn2" type ="button" value="批量删除" onclick="delAllStu();"/></th>
                                            </tr>
                                            <%
												Vector<Member> v = (Vector<Member>)session.getAttribute("allStu");//拿到所有用户的信息
                                        ...
                                        <tbody>
                                            ...
                                            <tr onmouseover="this.style.backgroundColor='#F0F8FF';" onmouseout="this.style.backgroundColor='#FFFFFF';">
												...
												<td><%=m.getSex() %></td>
												<td><%=m.getClasses() %></td>
												<td><%=m.getSpecialty() %></td>
												<td>
													<a href="updateStu.jsp?sno=<%=m.getSno()%>">修改</a>
													<a href="updateStu?f=del&sno=<%=m.getSno() %>" onclick="return confirm('确认删除？');">删除</a>
												</td>
                                            </tr>
											<%		
												}
