                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <div class="panel panel-default plain toggle panelClose panelRefresh">
                                ...
                                <h4 class="panel-title">学院基本信息</h4>
                                </div>
                                    ...
                                    <table class="table">
                                        <thead>
                                            <tr onmouseover="this.style.backgroundColor='#F0F8FF';" onmouseout="this.style.backgroundColor='#FFFFFF';">
                                                ...
                                                <th class="per15">学生号</th>
                                                <th class="per15">社团号</th>
                                                <th class="per15">学院名</th>
                                                <th class="per15">院长名</th>
                                                <th><input id="btn2" type ="button" value="批量删除" onclick="delAllAca();"/></th>
                                            </tr>
                                            <%
                                        ...
                                        <tbody>
                                            <tr onmouseover="this.style.backgroundColor='#F0F8FF';" onmouseout="this.style.backgroundColor='#FFFFFF';">
												...
												<td>
													<a href="updateAca.jsp?sno=<%=m.getSno()%>">修改</a>
													<a href="updateAca?f=del&sno=<%=m.getSno() %>" onclick="return confirm('确定删除该条记录吗?');">删除</a>
												</td>
                                            </tr>
											<%		
												}
