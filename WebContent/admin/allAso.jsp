            ...
            <div class="sidebar-inner">
                <ul id="sideNav" class="nav nav-pills nav-stacked">
                    ...
                    <li><a href="#"> 社团管理<i class="im-table2"></i></a>
                        <ul class="nav sub">
                            <li><a href="tableStu.html"><i class="en-arrow-right7"></i>学生基本表</a></li>
                            <li><a href="tableAso.html"><i class="en-arrow-right7"></i>社团基本表</a></li>
                            <li><a href="tableAca.html"><i class="en-arrow-right7"></i>学院基本表</a></li>
                        </ul>
                    </li>
                    <li><a><i class="im-images"></i> 社团活动</a></li>
                    <li><a href="#">社团信息<i class="im-table2"></i></a>
                        <ul class="nav sub">
                        	<li><a href="findAllStu"><i class="en-arrow-right7"></i>学生信息</a></li>
                            <li><a href="findAllAso"><i class="en-arrow-right7"></i>社团信息</a></li>
                            <li><a href="findAllAca"><i class="en-arrow-right7"></i>学院信息</a></li>
                        </ul>
                    </li>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <div class="panel panel-default plain toggle panelClose panelRefresh">
                                ...
                                <h4 class="panel-title">社团基本信息</h4>
                                </div>
                                    ...
                                    <table class="table">
                                        <thead>
                                            <tr onmouseover="this.style.backgroundColor='#F0F8FF';" onmouseout="this.style.backgroundColor='#FFFFFF';">
                                                ...
                                                <th class="per15">社团号</th>
                                                <th class="per15">社团名</th>
                                                <th class="per15">社团负责人</th>
                                                <th class="per15">社团指导老师</th>
                                                <th><input id="btn2" type ="button" value="批量删除" onclick="delAllAso();"/></th>
                                            </tr>
                                            <%
												Vector<Association> v = (Vector<Association>)session.getAttribute("allAso");//拿到所有用户的信息
                                        ...
                                        <tbody>
                                            <tr onmouseover="this.style.backgroundColor='#F0F8FF';" onmouseout="this.style.backgroundColor='#FFFFFF';">
												...
												<td><%=m.getAteacher() %></td>
												<td>
													<a href="updateAso.jsp?ano=<%=m.getAno()%>">修改</a>
													<a href="updateAso?f=del&ano=<%=m.getAno() %>" onclick="return confirm('确认删除？');">删除</a>
												</td>
                                            </tr>
											<%		
												}
